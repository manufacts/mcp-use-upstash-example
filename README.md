...
unmetered discovery. They do not prove the hosted Redis algorithm; use the Inspector steps above
for a live check with your credentials.
...
Source: [mcp-use Upstash example](https://github.com/mcp-use/mcp-use/tree/main/libraries/typescript/packages/server/examples/upstash).
